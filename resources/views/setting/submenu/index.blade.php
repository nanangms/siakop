...
<x-modalsm id="ShowTambah" title="Tambah Sub Menu">
    <form action="/setting/submenu/tambah" method="post">
        ...
        <x-forms.input_v id="nama_menu" type="text" name="nama_menu" label="Nama Sub Menu" isRequired="true" value=""/>
        <x-forms.input_v id="url" type="text" name="url" label="URL" isRequired="true" value=""/>
        <x-forms.input_v id="icon" type="text" name="icon" label="Icon" isRequired="true" value=""/>
