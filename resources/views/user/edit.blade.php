      ...
      <div class="card-body">
        <div class="tab-content" id="custom-tabs-one-tabContent">
          <div class="tab-pane fade show active" id="profil" role="tabpanel" aria-labelledby="profil-tab">
            ...
            {{csrf_field()}}
            <x-forms.input_h id="name" type="text" name="name" label="Nama Lengkap" isRequired="true" value="{{$user->name}}" isReadonly="" placeholder=""/>
            <x-forms.input_h id="email" type="email" name="email" label="E-mail" isRequired="true" value="{{$user->email}}" isReadonly="" placeholder=""/>
            <x-forms.input_h id="no_hp" type="text" name="no_hp" label="No. Hp" isRequired="false" value="{{$user->no_hp}}" isReadonly="" placeholder=""/>
          ...
          <div class="tab-pane fade" id="ganti-password" role="tabpanel" aria-labelledby="ganti-password-tab">
            ...
            <form action="/user/{{$user->uuid}}/ganti_password" method="post">
                    {{csrf_field()}}
                    <x-forms.input_h id="password" type="text" name="password" label="Password Baru" isRequired="false" value="" isReadonly="" placeholder=""/>
                    <x-forms.input_h id="password" type="text" name="password_baru" label="Konfirmasi Password Baru" isRequired="false" value="" isReadonly="" placeholder=""/>
